...
export default function HeaderPage(props: HeaderPageProps) {
        return (
                <>
                        <h2 className="text-3xl font-bold text-center mb-6">{props.HeadTitle}</h2>
                        <div className="flex justify-start items-center mt-5">
                                ...
                                <div className="ml-4">
                                        <p className="text-lg font-semibold">{props.NameTeach}</p>
                                        <p className="text-green-500 text-xl font-bold mt-2">{props.Prices}</p>
                                </div>
                        </div>
                </>
        )
