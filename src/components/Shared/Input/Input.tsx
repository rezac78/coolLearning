        ...
        return (
                <>
                        {props.Type === "validation" ? <div key={props.Ekey} className="mb-4">
                                ...
                                <input type={props.type} value={props.value} id={props.IdName} {...props.Register(props.IdName)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-light-bg-Input dark:bg-dark-bg-Input leading-tight focus:outline-none focus:shadow-outline" />
