...
export default function Inputs(props: InputProps) {
        ...
        return (
                <>
                        {props.Type === "validation" ? <div  className="mb-4">
                                <label htmlFor={uniqueId} className="block text-light-color-Input-label dark:text-dark-color-Input-label text-sm font-bold mb-2">{props.LabelName}</label>
