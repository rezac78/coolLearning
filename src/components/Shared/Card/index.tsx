                ...
                <div key={props.keyPart} className="group/item border-y-4 border-dark-bg-border dark:border-light-bg-border p-1 max-w-72 sm:max-w-80 transition duration-700 rounded overflow-hidden shadow-lg hover:-translate-y-6">
                        <div className="relative">
                                ...
                                <div className="group/edit invisible group-hover/item:visible absolute top-5 left-1 flex items-center">
                                        {props.type === 'blog' ? null : <ImagePart className="w-10 h-10 rounded-full mr-2" Src={props.instructorPoster ?? ""} width={80} height={80} />}
                                        <div>
                        ...
                        <div className="px-4 py-4">
                                ...
                                <Button Click={() => router.push(`/${props.type}/${props.LinkId}`)} className="w-24 mt-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-700" Title="Continue" Type={""} />
                        </div>
                        <div className="border-t border-gray-200 px-4 py-3">
                                <div className="flex justify-between text-xs text-light-color-Font dark:text-dark-color-Font">
                                        {props.type === 'blog' ?
                                                <>
                                                        <span className="text-red-500"><HeartIcon width={20} height={20} /> 25</span>
                                                        <span className="text-blue-300"><ChatBubbleOvalLeftIcon width={20} height={20} /> 25</span>
                                                </>
                                                :
                                                <>
