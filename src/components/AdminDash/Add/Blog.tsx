...
export default function AddBlog() {
        ...
        return (
                <div className="min-h-full">
                        ...
                        <HeaderDash Type="home" HeadTitle="Add-Blog" HeadLink="" />
                        {showSuccessMessage && <Alerts Message={SuccessMessage} type={numberSuccessMessage} />}
                        <main>
                                <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                                        <BlogForm Message={setShowSuccessMessage} SuccessMessage={setNumberSuccessMessage} Success={setSuccessMessage} />
                                </div>
                        </main>
                </div>
        )
