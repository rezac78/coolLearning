                                ...
                                <div className="max-w-6xl mx-auto mt-5">
                                        ...
                                        <div className="flex flex-col md:flex-row mt-5">
                                                <div className="md:flex-1 w-full md:w-2/6 p-4 rounded-lg shadow hover:shadow-xl transition-shadow duration-300">
                                                        <div className="mt-6">
                                                                <LeftSide blogsData={props.blogsData} creatorScope={props.initialBlogData.creatorScope} Profile={props.initialBlogData.creatorPhoto} tags={props.initialBlogData.tags} creatorName={props.initialBlogData.creatorName} />
                                                        </div>
                                                </div>
