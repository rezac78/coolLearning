                ...
                <div className="container mx-auto px-4 py-8 overflow-x-hidden">
                        <div className="flex flex-wrap items-center">
                                <div className="w-full md:w-1/2" data-aos="fade-right">
                                        <h2 className="text-2xl font-bold mb-2">Reza Dalvand</h2>
                                ...
                                <div className="w-full md:w-1/2 text-center" data-aos="fade-left">
                                        <img src="/reza1.jpg" alt="Person 1" className="inline-block h-80 w-80 object-cover rounded-full shadow-lg" />
                                </div>
                        </div>
                        <div className="flex flex-wrap items-center mt-8">
                                <div className="w-full md:w-1/2 text-center" data-aos="fade-right">
                                        <img src="/reza2.jpg" alt="Person 2" className="inline-block h-80 w-80 object-cover rounded-full shadow-lg" />
                                </div> 
